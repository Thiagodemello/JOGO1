...
var Player = /** @class */ (function () {
    function Player(canvas, ctx) {
        ...
        this.width = 40; // Define a largura do jogador
        this.height = 50; // Define a altura do jogador
    }
...
var Obstacle = /** @class */ (function () {
    function Obstacle(canvas, ctx) {
        ...
        this.width = 55; // Define a largura do obstáculo
...
var Game = /** @class */ (function () {
    function Game(canvas, ctx) {
        ...
        this.speed = 10; // Define a velocidade inicial dos obstáculos
    ...
    Game.prototype.update = function () {
        ...
        for (var _i = 0, _a = this.obstacles; _i < _a.length; _i++) {
            ...
            if (obstacle.y > this.canvas.height - 20 &&
